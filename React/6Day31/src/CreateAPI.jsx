...
export default function CreateAPI(){
    ...
    const AddFood = async ()=>{
        try{
                ...
                body: JSON.stringify({
                    name:'gangan',
                    description :'mkanan khas belitung berupa ikan dengan kuah berwarna kuning',
                    imageUrl:"ttps://iamafoodblog.b-cdn.net/wp-content/uploads/2023/01/chicken-pot-pie-shells-7211w-1024x682.webp",
                    ingredients:[],
                })
            });
            alert("Sukses")
